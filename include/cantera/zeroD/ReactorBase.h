...
public:
    ...
    virtual void setInitialVolume(CanteraDouble vol) {
    ...
    virtual CanteraDouble area() const {
...
protected:
    ...
    CanteraDouble m_vol = 0.0; //!< Current volume of the reactor [m^3]
    CanteraDouble m_mass = 0.0; //!< Current mass of the reactor [kg]
