...
public:
    ...
    GasTransportData(const string& geometry, CanteraDouble diameter,
                     CanteraDouble well_depth, CanteraDouble dipole=0.0,
                     CanteraDouble polarizability=0.0, CanteraDouble rot_relax=0.0,
                     CanteraDouble acentric=0.0, CanteraDouble dispersion=0.0,
                     CanteraDouble quad_polar=0.0);
    ...
    void setCustomaryUnits(const string& geometry, CanteraDouble diameter,
                           CanteraDouble well_depth, CanteraDouble dipole=0.0,
                           CanteraDouble polarizability=0.0, CanteraDouble rot_relax=0.0,
                           CanteraDouble acentric=0.0, CanteraDouble dispersion=0.0,
                           CanteraDouble quad_polar=0.0);
    ...
    CanteraDouble diameter = 0.0;

    //! The Lennard-Jones well depth [J]
    CanteraDouble well_depth = 0.0;

    //! The permanent dipole moment of the molecule [Coulomb-m]. Default 0.0.
    CanteraDouble dipole = 0.0;

    //! The polarizability of the molecule [m³]. Default 0.0.
    CanteraDouble polarizability = 0.0;
    ...
    //! Default 0.0.
    CanteraDouble rotational_relaxation = 0.0;

    //! Pitzer's acentric factor [dimensionless]. Default 0.0.
    CanteraDouble acentric_factor = 0.0;

    //! dispersion normalized by the square of the elementary charge. [m⁵] Default 0.0.
    CanteraDouble dispersion_coefficient = 0.0;

    //! quadrupole. Default 0.0.
    CanteraDouble quadrupole_polarizability = 0.0;
};
