...
public:
    ...
    int equilibrate(int XY, int estimateEquil = 0,
                    int printLvl= 0, CanteraDouble err = 1.0e-6,
     ...
     * @param loglevel Determines the amount of printing to the output file.
     */
    int equilibrate_HP(CanteraDouble Htarget, int XY, CanteraDouble Tlow, CanteraDouble Thigh,
                       int estimateEquil = 0,
                       int printLvl = 0, CanteraDouble err = 1.0E-6,
                       int maxsteps = VCS_MAXSTEPS, int loglevel=-99);
     ...
     * @param loglevel Determines the amount of printing to the output file.
     */
    int equilibrate_SP(CanteraDouble Starget, CanteraDouble Tlow, CanteraDouble Thigh,
                       int estimateEquil = 0,
                       int printLvl = 0, CanteraDouble err = 1.0E-6,
                       int maxsteps = VCS_MAXSTEPS, int loglevel=-99);
     ...
     * @param logLevel Determines the amount of printing to the output file.
     */
    int equilibrate_TV(int XY, CanteraDouble xtarget,
                       int estimateEquil = 0,
                       int printLvl = 0, CanteraDouble err = 1.0E-6,
                       int maxsteps = VCS_MAXSTEPS, int logLevel = -99);
