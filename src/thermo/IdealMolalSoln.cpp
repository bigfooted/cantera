...
CanteraDouble IdealMolalSoln::enthalpy_mole() const
{
...
CanteraDouble IdealMolalSoln::entropy_mole() const
{
    getPartialMolarEntropies(m_tmpV.data());
    return mean_X(m_tmpV);
}

CanteraDouble IdealMolalSoln::gibbs_mole() const
{
    getChemPotentials(m_tmpV.data());
    return mean_X(m_tmpV);
}

CanteraDouble IdealMolalSoln::cp_mole() const
{
