...
string demangle(const std::type_info& type)
{
    static map<string, string> typenames = {
        ...
        {typeid(CanteraDouble).name(), "CanteraDouble"},
        ...
        {typeid(vector<CanteraDouble>).name(), "vector<CanteraDouble>"},
        {typeid(vector<long int>).name(), "vector<long int>"},
        {typeid(vector<bool>).name(), "vector<bool>"},
        {typeid(vector<string>).name(), "vector<string>"},
        {typeid(vector<vector<CanteraDouble>>).name(), "vector<vector<CanteraDouble>>"},
